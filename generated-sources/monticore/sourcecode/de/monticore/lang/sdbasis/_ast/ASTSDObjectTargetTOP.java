...
/* Hookpoint: ClassContent:Annotations */
 ...
 abstract  public  class ASTSDObjectTargetTOP extends ASTCNode  implements de.monticore.lang.sdbasis._ast.ASTSDTarget,de.monticore.lang.sdbasis._ast.ASTSDBasisNode {
...
;
 ...
 protected  ASTSDObjectTargetTOP()
 {
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    /* generated by template data.DeepEqualsWithOrder*/
      ...
      ASTSDObjectTarget comp;
    if ((o instanceof ASTSDObjectTarget)) {
      comp = (ASTSDObjectTarget) o;
    } else {
      return false;
    }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    // We allow a down cast here, because the subclass ASTSDObjectTarget must exist
    ...
    if (this instanceof ASTSDObjectTarget) {
      visitor.handle((ASTSDObjectTarget) this);
    } else {
      throw new UnsupportedOperationException("0xA7011x73849 Only handwritten class ASTSDObjectTarget is supported for the visitor");
    }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sdbasis._visitor.SDBasisTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x12422 AST node type ASTSDObjectTarget expected a visitor of type de.monticore.lang.sdbasis._visitor.SDBasisTraverser, but got de.monticore.symbols.basicsymbols._visitor.BasicSymbolsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sdbasis._visitor.SDBasisTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x74502 AST node type ASTSDObjectTarget expected a visitor of type de.monticore.lang.sdbasis._visitor.SDBasisTraverser, but got de.monticore.expressions.expressionsbasis._visitor.ExpressionsBasisTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sdbasis._visitor.SDBasisTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x05301 AST node type ASTSDObjectTarget expected a visitor of type de.monticore.lang.sdbasis._visitor.SDBasisTraverser, but got de.monticore.umlstereotype._visitor.UMLStereotypeTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sdbasis._visitor.SDBasisTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x42653 AST node type ASTSDObjectTarget expected a visitor of type de.monticore.lang.sdbasis._visitor.SDBasisTraverser, but got de.monticore.mcbasics._visitor.MCBasicsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sdbasis._visitor.SDBasisTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x20221 AST node type ASTSDObjectTarget expected a visitor of type de.monticore.lang.sdbasis._visitor.SDBasisTraverser, but got de.monticore.literals.mcliteralsbasis._visitor.MCLiteralsBasisTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sdbasis._visitor.SDBasisTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x40535 AST node type ASTSDObjectTarget expected a visitor of type de.monticore.lang.sdbasis._visitor.SDBasisTraverser, but got de.monticore.literals.mccommonliterals._visitor.MCCommonLiteralsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sdbasis._visitor.SDBasisTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x92429 AST node type ASTSDObjectTarget expected a visitor of type de.monticore.lang.sdbasis._visitor.SDBasisTraverser, but got de.monticore.visitor.ITraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
 ...
 {
    return de.monticore.lang.sdbasis.SDBasisMill.sDObjectTargetBuilder().uncheckedBuild();
}
