...
/* Hookpoint: ClassContent:Annotations */
 ...
 abstract  public  class SD4DevelopmentToolTOP  {
...
try{
   ...
   Log.error("0xA5C06x41805 Could not process SD4DevelopmentTool parameters: " + e.getMessage());
 }
}
...
try {
      de.monticore.lang.sd4development._parser.SD4DevelopmentParser parser = de.monticore.lang.sd4development.SD4DevelopmentMill.parser() ;
      Optional<de.monticore.lang.sdbasis._ast.ASTSDArtifact> optAst = parser.parse(model);

      if (!parser.hasErrors() && optAst.isPresent()) {
        return optAst.get();
      }
      Log.error("0xA1050x99003 Model could not be parsed.");
    }
    catch (NullPointerException | java.io.IOException e) {
      Log.error("0xA1051x59703 Failed to parse " + model, e);
    }
...
Log.init();
de.monticore.lang.sd4development.SD4DevelopmentMill.init();
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  de.monticore.lang.sd4development._prettyprint.SD4DevelopmentFullPrettyPrinter prettyPrinter = new de.monticore.lang.sd4development._prettyprint.SD4DevelopmentFullPrettyPrinter(new de.monticore.prettyprint.IndentPrinter());
...
// print to stdout or file
  if (path.isEmpty()) {
    ...
    try {
      ...
      Log.error("0xA7105x96661 Could not write to file " + f.getAbsolutePath());
    }
  }
}
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  formatter.printHelp("SD4DevelopmentTool", options);
...
final String toolName = "SD4DevelopmentTool";
final String mcVersion = "7.6.0-SNAPSHOT";
...
/* Hookpoint: MethodContent:Annotations */
 ...
 {
    Log.warn("0xA1058x49132 Reports are not implemented yet.");
}
...
/* Hookpoint: MethodContent:Annotations */
 ...
 {
    Log.warn("0xA1053x60205 default CoCos are not implemented yet.");
}
...
/* Hookpoint: MethodContent:Annotations */
 ...
 {
    Log.warn("0xA1062x17471 additional CoCos are not implemented yet.");
}
...
de.monticore.lang.sd4development._symboltable.SD4DevelopmentSymbols2Json symbols2Json = new de.monticore.lang.sd4development._symboltable.SD4DevelopmentSymbols2Json();
...
de.monticore.lang.sd4development._symboltable.SD4DevelopmentScopesGenitorDelegator genitor = de.monticore.lang.sd4development.SD4DevelopmentMill.scopesGenitorDelegator();
de.monticore.lang.sd4development._symboltable.ISD4DevelopmentArtifactScope symTab = genitor.createFromAST(node);
return symTab;
}
...
/* Hookpoint: MethodContent:Annotations */
 ...
 {
    Log.warn("0xA1158x95675 This symbol table phase is not implemented yet.");
}
