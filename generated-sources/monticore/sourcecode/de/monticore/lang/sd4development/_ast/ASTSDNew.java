...
/* Hookpoint: ClassContent:Annotations */
 ...
 public  class ASTSDNew extends ASTCNode  implements de.monticore.lang.sdbasis._ast.ASTSDInteraction,de.monticore.symbols.basicsymbols._ast.ASTVariable,de.monticore.lang.sd4development._ast.ASTSD4DevelopmentNode {
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    if ( this.sDSource.isPresent() != comp.sDSource.isPresent() ||
     ...
     // comparing declarationType
     if ( (this.declarationType == null && comp.declarationType != null) ||
        (this.declarationType != null && !this.declarationType.deepEquals(comp.declarationType, forceSameOrder)) ) {
        return false;
     }
     // comparing initializationType
     if ( (this.initializationType == null && comp.initializationType != null) ||
        (this.initializationType != null && !this.initializationType.deepEquals(comp.initializationType, forceSameOrder)) ) {
        return false;
     }
     // comparing arguments
     if ( (this.arguments == null && comp.arguments != null) ||
        (this.arguments != null && !this.arguments.deepEquals(comp.arguments, forceSameOrder)) ) {
        return false;
     }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    if ( this.sDSource.isPresent() != comp.sDSource.isPresent() ||
      ...
      // comparing declarationType
      if ( (this.declarationType == null && comp.declarationType != null) ||
        (this.declarationType != null && !this.declarationType.deepEqualsWithComments(comp.declarationType, forceSameOrder)) ) {
        return false;
      }
      // comparing initializationType
      if ( (this.initializationType == null && comp.initializationType != null) ||
        (this.initializationType != null && !this.initializationType.deepEqualsWithComments(comp.initializationType, forceSameOrder)) ) {
        return false;
      }
      // comparing arguments
      if ( (this.arguments == null && comp.arguments != null) ||
        (this.arguments != null && !this.arguments.deepEqualsWithComments(comp.arguments, forceSameOrder)) ) {
        return false;
      }
    // comparing sDActivityBar
    if ( this.sDActivityBar.isPresent() != comp.sDActivityBar.isPresent() ||
...

 {
  ...
  for (de.monticore.ast.Comment x : get_PostCommentList()) {
    ...
    if (isPresentSDSource()){
      ...
      result.setDeclarationType(getDeclarationType().deepClone());
      result.setInitializationType(getInitializationType().deepClone());
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x45201 AST node type ASTSDNew expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.ocl.oclexpressions._visitor.OCLExpressionsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x60676 AST node type ASTSDNew expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.symbols.oosymbols._visitor.OOSymbolsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x13046 AST node type ASTSDNew expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.types.mcbasictypes._visitor.MCBasicTypesTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x28544 AST node type ASTSDNew expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.symbols.basicsymbols._visitor.BasicSymbolsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x76881 AST node type ASTSDNew expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.umlstereotype._visitor.UMLStereotypeTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x51689 AST node type ASTSDNew expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.mcbasics._visitor.MCBasicsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x57319 AST node type ASTSDNew expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.visitor.ITraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
 ...
 {
    return de.monticore.lang.sd4development.SD4DevelopmentMill.sDNewBuilder().uncheckedBuild();
}
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    Log.error("0xA7003x81154 get for Symbol can't return a value. Attribute is empty.");
    // Normally this statement is not reachable
    throw new IllegalStateException();
