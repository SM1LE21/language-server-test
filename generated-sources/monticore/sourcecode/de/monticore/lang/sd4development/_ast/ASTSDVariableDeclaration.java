...
/* Hookpoint: ClassContent:Annotations */
 ...
 public  class ASTSDVariableDeclaration extends ASTCNode  implements de.monticore.lang.sdbasis._ast.ASTSDElement,de.monticore.symbols.basicsymbols._ast.ASTVariable,de.monticore.lang.sd4development._ast.ASTSD4DevelopmentNode {
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    /* generated by template data.DeepEqualsWithOrder*/
      ...
      ASTSDVariableDeclaration comp;
    if ((o instanceof ASTSDVariableDeclaration)) {
      comp = (ASTSDVariableDeclaration) o;
    } else {
      return false;
    }
    if (!equalAttributes(comp)) {
     ...
     if ( (this.assignment == null && comp.assignment != null) ||
        (this.assignment != null && !this.assignment.deepEquals(comp.assignment, forceSameOrder)) ) {
        return false;
     }
    return true;     
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    if (!equalsWithComments(comp)) {
      ...
      // comparing assignment
      if ( (this.assignment == null && comp.assignment != null) ||
        (this.assignment != null && !this.assignment.deepEqualsWithComments(comp.assignment, forceSameOrder)) ) {
        return false;
      }
    return true;     
...

 {
  ...
  for (de.monticore.ast.Comment x : get_PostCommentList()) {
    result.get_PostCommentList().add(new de.monticore.ast.Comment(x.getText()));
      ...
      result.setAssignment(getAssignment().deepClone());
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x85535 AST node type ASTSDVariableDeclaration expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.literals.mccommonliterals._visitor.MCCommonLiteralsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x40230 AST node type ASTSDVariableDeclaration expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.expressions.commonexpressions._visitor.CommonExpressionsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x93775 AST node type ASTSDVariableDeclaration expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.ocl.oclexpressions._visitor.OCLExpressionsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x00826 AST node type ASTSDVariableDeclaration expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.symbols.oosymbols._visitor.OOSymbolsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x81012 AST node type ASTSDVariableDeclaration expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.types.mcbasictypes._visitor.MCBasicTypesTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x77118 AST node type ASTSDVariableDeclaration expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.symbols.basicsymbols._visitor.BasicSymbolsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x89902 AST node type ASTSDVariableDeclaration expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.expressions.expressionsbasis._visitor.ExpressionsBasisTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x84621 AST node type ASTSDVariableDeclaration expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.umlstereotype._visitor.UMLStereotypeTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x04235 AST node type ASTSDVariableDeclaration expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.mcbasics._visitor.MCBasicsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x61141 AST node type ASTSDVariableDeclaration expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.literals.mcliteralsbasis._visitor.MCLiteralsBasisTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x05541 AST node type ASTSDVariableDeclaration expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.visitor.ITraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
 ...
 {
    return de.monticore.lang.sd4development.SD4DevelopmentMill.sDVariableDeclarationBuilder().uncheckedBuild();
}
