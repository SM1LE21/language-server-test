...
/* Hookpoint: ClassContent:Annotations */
 ...
 abstract  public  class ASTSDClassTOP extends ASTCNode  implements de.monticore.lang.sdbasis._ast.ASTSDSource,de.monticore.lang.sdbasis._ast.ASTSDTarget,de.monticore.lang.sd4development._ast.ASTSD4DevelopmentNode {
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    if (!equalAttributes(comp)) {
     ...
     if ( (this.mCObjectType == null && comp.mCObjectType != null) ||
        (this.mCObjectType != null && !this.mCObjectType.deepEquals(comp.mCObjectType, forceSameOrder)) ) {
        return false;
     }
    return true;     
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    if (!equalsWithComments(comp)) {
      ...
      // comparing mCObjectType
      if ( (this.mCObjectType == null && comp.mCObjectType != null) ||
        (this.mCObjectType != null && !this.mCObjectType.deepEqualsWithComments(comp.mCObjectType, forceSameOrder)) ) {
        return false;
      }
    return true;     
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    return o instanceof ASTSDClass;
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    // We allow a down cast here, because the subclass ASTSDClass must exist
    ...
    if (this instanceof ASTSDClass) {
      visitor.handle((ASTSDClass) this);
    } else {
      throw new UnsupportedOperationException("0xA7011x64519 Only handwritten class ASTSDClass is supported for the visitor");
    }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x40101 AST node type ASTSDClass expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.literals.mccommonliterals._visitor.MCCommonLiteralsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x24332 AST node type ASTSDClass expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.expressions.commonexpressions._visitor.CommonExpressionsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x20183 AST node type ASTSDClass expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.ocl.oclexpressions._visitor.OCLExpressionsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x24788 AST node type ASTSDClass expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.symbols.oosymbols._visitor.OOSymbolsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x55410 AST node type ASTSDClass expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.types.mcbasictypes._visitor.MCBasicTypesTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x30456 AST node type ASTSDClass expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.symbols.basicsymbols._visitor.BasicSymbolsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x37556 AST node type ASTSDClass expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.expressions.expressionsbasis._visitor.ExpressionsBasisTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x08583 AST node type ASTSDClass expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.umlstereotype._visitor.UMLStereotypeTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x57231 AST node type ASTSDClass expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.mcbasics._visitor.MCBasicsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x40433 AST node type ASTSDClass expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.literals.mcliteralsbasis._visitor.MCLiteralsBasisTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x80127 AST node type ASTSDClass expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.visitor.ITraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
 ...
 {
    return de.monticore.lang.sd4development.SD4DevelopmentMill.sDClassBuilder().uncheckedBuild();
}
