...
/* Hookpoint: MethodContent:Annotations */
...

 {
    /* generated by template data.DeepEqualsWithOrder*/
      ...
      ASTSDCondition comp;
    if ((o instanceof ASTSDCondition)) {
      comp = (ASTSDCondition) o;
    } else {
      return false;
    }
    if (!equalAttributes(comp)) {
     ...
     if ( (this.expression == null && comp.expression != null) ||
        (this.expression != null && !this.expression.deepEquals(comp.expression, forceSameOrder)) ) {
        return false;
     }
    return true;     
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    if (!equalsWithComments(comp)) {
      ...
      // comparing expression
      if ( (this.expression == null && comp.expression != null) ||
        (this.expression != null && !this.expression.deepEqualsWithComments(comp.expression, forceSameOrder)) ) {
        return false;
      }
    return true;     
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    return o instanceof ASTSDCondition;
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x38548 AST node type ASTSDCondition expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.ocl.oclexpressions._visitor.OCLExpressionsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x02185 AST node type ASTSDCondition expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.symbols.oosymbols._visitor.OOSymbolsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x69551 AST node type ASTSDCondition expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.types.mcbasictypes._visitor.MCBasicTypesTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x18390 AST node type ASTSDCondition expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.umlstereotype._visitor.UMLStereotypeTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x54926 AST node type ASTSDCondition expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.mcbasics._visitor.MCBasicsTraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0x70000x39454 AST node type ASTSDCondition expected a visitor of type de.monticore.lang.sd4development._visitor.SD4DevelopmentTraverser, but got de.monticore.visitor.ITraverser. Visitors of a super language may not be used on Symbols containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
 ...
 {
    return de.monticore.lang.sd4development.SD4DevelopmentMill.sDConditionBuilder().uncheckedBuild();
}
