...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  List<de.monticore.symboltable.ISymbol> topSymbolList = new ArrayList<>();
    topSymbolList.addAll(getOOTypeSymbols().values());
    topSymbolList.addAll(getFieldSymbols().values());
    topSymbolList.addAll(getMethodSymbols().values());
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  final Set<de.monticore.symbols.oosymbols._symboltable.OOTypeSymbol> result = new HashSet<>();
...
if (!(getEnclosingScope() instanceof IGlobalScope)) {
  ...
  final List<de.monticore.symbols.oosymbols._symboltable.OOTypeSymbol> resolvedFromEnclosing = getEnclosingScope().resolveOOTypeMany(foundSymbols,
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  final Set<de.monticore.symbols.oosymbols._symboltable.FieldSymbol> result = new HashSet<>();
...
if (!(getEnclosingScope() instanceof IGlobalScope)) {
    ...
    for (final String potentialQualifiedName : potentialQualifiedNames) {
  final List<de.monticore.symbols.oosymbols._symboltable.FieldSymbol> resolvedFromEnclosing = getEnclosingScope().resolveFieldMany(foundSymbols,
  potentialQualifiedName, modifier, predicate);
      foundSymbols = foundSymbols | resolvedFromEnclosing.size() > 0;
      result.addAll(resolvedFromEnclosing);
    }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  final Set<de.monticore.symbols.oosymbols._symboltable.MethodSymbol> result = new HashSet<>();
...
if (!(getEnclosingScope() instanceof IGlobalScope)) {
    ...
    for (final String potentialQualifiedName : potentialQualifiedNames) {
  final List<de.monticore.symbols.oosymbols._symboltable.MethodSymbol> resolvedFromEnclosing = getEnclosingScope().resolveMethodMany(foundSymbols,
  potentialQualifiedName, modifier, predicate);
      foundSymbols = foundSymbols | resolvedFromEnclosing.size() > 0;
      result.addAll(resolvedFromEnclosing);
    }
