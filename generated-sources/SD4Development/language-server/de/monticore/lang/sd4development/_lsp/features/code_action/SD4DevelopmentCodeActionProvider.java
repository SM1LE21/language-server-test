...
package de.monticore.lang.sd4development._lsp.features.code_action;
...
public class SD4DevelopmentCodeActionProvider implements CodeActionProvider {
    private static final Logger logger = LoggerFactory.getLogger(SD4DevelopmentCodeActionProvider.class);
    protected final DocumentManager documentManager;
    protected final AstPrettyPrinter<ASTSDArtifact> prettyPrinter;

    public SD4DevelopmentCodeActionProvider(DocumentManager documentManager, AstPrettyPrinter<ASTSDArtifact> prettyPrinter) {
