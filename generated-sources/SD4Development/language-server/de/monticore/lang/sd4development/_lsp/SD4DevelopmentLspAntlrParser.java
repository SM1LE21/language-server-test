...
import de.monticore.lang.sd4development._lsp.features.completion.SD4DevelopmentExpectedTokenVisitor;
import de.monticore.lang.sd4development._parser.SD4DevelopmentAntlrParser;
...
public class SD4DevelopmentLspAntlrParser extends SD4DevelopmentAntlrParser implements LspParser {
	...
	private SD4DevelopmentExpectedTokenVisitor expectedTokenVisitor;
    public SD4DevelopmentLspAntlrLexer lexer;

    public SD4DevelopmentLspAntlrParser(TokenStream input) {
        super(input);
        exchangeErrorListener();
    }

    private void exchangeErrorListener() {
        expectedTokenVisitor = new SD4DevelopmentExpectedTokenVisitor(this);
	...
	public SD4DevelopmentExpectedTokenVisitor getExpectedTokenVisitor(){
    ...
    protected MatchedToken getTokenInformation(Token token, boolean isNameToken) {
        ...
        matchedToken.isNameToken = !matchedToken.isLocalKeyword && isNameToken;
				matchedToken.isDefiningName = SD4DevelopmentParserInfo.stateDefinesName(matchedToken.parserState);
