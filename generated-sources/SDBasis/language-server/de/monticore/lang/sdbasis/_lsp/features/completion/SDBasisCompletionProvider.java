...
public class SDBasisCompletionProvider extends CommonCompletionProvider {
    private static final Logger logger = LoggerFactory.getLogger(SDBasisCompletionProvider.class);
    protected final SDBasisLanguageAccess languageAccess;
    protected SDBasisCompletionAntlrParser parser;
    protected ISymbolUsageResolutionProvider symbolUsageResolutionProvider;

    public SDBasisCompletionProvider(CommonLanguageServer languageServer, DocumentManager documentManager, SDBasisLanguageAccess languageAccess, ISymbolUsageResolutionProvider symbolUsageResolutionProvider) {
        ...
        completionStrategyManager.registerDefaultCompletionStrategy(new SDBasisDefaultCompletionStrategy(symbolUsageResolutionProvider, documentManager));
    ...
    public void registerSymbolRefCompletionStrategies(){
			completionStrategyManager.registerCompletionStrategy(new de.monticore.lang.sdbasis._lsp.features.completion.strategy.referenced_symbol.VariableReferencedSymbolStrategy(symbolUsageResolutionProvider, documentManager));
    }
    ...
    public void registerNoSymbolNamesAtSymbolDef(){
      completionStrategyManager.registerCompletionStrategy(new CompletionStrategy(){
        public boolean matches(ExpectedToken expectedToken){
          return expectedToken.isSymbol && SDBasisParserInfo.stateDefinesName(expectedToken.parserState);
        }
