...
public class SDBasisCompletionAntlrParser extends SDBasisLspAntlrParser implements CompletionLspParser {
    private StateWithContext[] firstStatesOfParserCompletion;
    private AutocompletionErrorStrategy completionErrorStrategy;

    public SDBasisCompletionAntlrParser(TokenStream input) {
        super(input);
